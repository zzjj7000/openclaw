...
This app now ships Sparkle auto-updates. Release builds must be Developer ID鈥搒igned, zipped, and published with a signed appcast entry.
...
- Sanity checks:
  ...
  - On a previous public build, run 鈥淐heck for Updates鈥︹€?from the About tab and verify Sparkle installs the new build cleanly.
